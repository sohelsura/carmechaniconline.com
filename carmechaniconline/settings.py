"""
Django settings for carmechaniconline project.
...
SECRET_KEY = 'django-insecure-=^g!-!l(6(==g&g-)&elsdsvvkvy7!+o!ldsy%d8q5c(xu-^*z'
...
MIDDLEWARE = [
    ...
    'carmechaniconline.middleware.ForceWWWMiddleware',
]

ROOT_URLCONF = 'carmechaniconline.urls'
...
WSGI_APPLICATION = 'carmechaniconline.wsgi.application'
